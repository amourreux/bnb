<template>
    <div style="padding: 1.25rem">
        ...
        <div v-else class="border-bottom" v-for="(review, index) in reviews" :key="index">
            <div class="row pt-4">
                <div class="col-md-6">Joe Doe</div>
...
export default {
    ...
    created() {
        this.loading = true,
        axios.get(`/api/bookables/${this.bookableId}/reviews`).then(
